...
$topnav = get_config('theme_boost_union_child', 'displaytopnav');
$fullheader = get_config('theme_boost_union_child', 'displayfullheader');
$secondarynavigation = get_config('theme_boost_union_child', 'displaysecondarynavigation');

if ($PAGE->has_secondary_navigation() && $secondarynavigation) {
...
$templatecontext = [
    ...
    'secondarymoremenu' => $secondarynavigation ?: false, // To access like Settings etc.
    ...
    'topnav' => get_config('theme_boost_union_child', 'displaytopnav') ?? 0,
    'fullheader' => get_config('theme_boost_union_child', 'displayfullheader') ?? 0,
];
...
echo $OUTPUT->render_from_template('theme_boost_union_child/securedrawers', $templatecontext);
